...
import com.talentica.doEngine.client.telegram.model.request.*;
import com.talentica.doEngine.client.telegram.request.*;
import com.talentica.doEngine.client.telegram.response.*;
...
public abstract class OldTelegramBot {
    ...
    public String getFullFilePath(String fileId) {
        ...
        return fileApi.getFullFilePath(fileResponse.file().getFilePath());
    }
